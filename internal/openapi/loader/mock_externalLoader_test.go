...
func (_m *mockExternalLoader) LoadSwaggerFromFile(path string) (*openapi3.T, error) {
	ret := _m.Called(path)
...
func (_m *mockExternalLoader) LoadSwaggerFromURI(location *url.URL) (*openapi3.T, error) {
